...
// NOTE: If things start getting funky it might be because I'm using UDP 
...
// This code is specific to the knowledge base and you need to call the ParseResponse static method from the Knowledge class itself.
